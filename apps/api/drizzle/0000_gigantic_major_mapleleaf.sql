...
CREATE TYPE "public"."mode_of_transport" AS ENUM('lemozen', 'als', 'bls');--> statement-breakpoint
CREATE TYPE "public"."assistance_service_type" AS ENUM('TRANSPORT', 'MEDICAL');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "assistance_request_threads" (
	"assistance_request_id" uuid NOT NULL,
	"thread_id" text NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "assistance_request_threads_assistance_request_id_thread_id_pk" PRIMARY KEY("assistance_request_id","thread_id")
);
--> statement-breakpoint
CREATE TABLE "assistance_requests" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"request_number" text NOT NULL,
	"service_type" "assistance_service_type" NOT NULL,
	...
	"patient_nationality_code" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "assistance_requests_request_number_unique" UNIQUE("request_number")
);
--> statement-breakpoint
...
CREATE TABLE "transport_requests" (
	...
	"requested_transport_at" timestamp with time zone,
	"mode_of_transport" "mode_of_transport",
	"medical_crew_required" boolean DEFAULT false NOT NULL,
...
ALTER TABLE "assistance_request_threads" ADD CONSTRAINT "assistance_request_threads_assistance_request_id_assistance_requests_id_fk" FOREIGN KEY ("assistance_request_id") REFERENCES "public"."assistance_requests"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "medical_requests" ADD CONSTRAINT "medical_requests_request_id_assistance_requests_id_fk" FOREIGN KEY ("request_id") REFERENCES "public"."assistance_requests"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "transport_requests" ADD CONSTRAINT "transport_requests_request_id_assistance_requests_id_fk" FOREIGN KEY ("request_id") REFERENCES "public"."assistance_requests"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_medical_providers_created_at" ON "medical_providers" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_assistance_request_threads_request_id" ON "assistance_request_threads" USING btree ("assistance_request_id");--> statement-breakpoint
CREATE INDEX "idx_assistance_requests_service_type" ON "assistance_requests" USING btree ("service_type");--> statement-breakpoint
CREATE INDEX "idx_assistance_requests_status" ON "assistance_requests" USING btree ("status");--> statement-breakpoint
CREATE INDEX "idx_assistance_requests_provider_reference_number" ON "assistance_requests" USING btree ("provider_reference_number");--> statement-breakpoint
CREATE INDEX "idx_assistance_requests_received_at" ON "assistance_requests" USING btree ("received_at");--> statement-breakpoint
CREATE INDEX "idx_assistance_requests_created_at" ON "assistance_requests" USING btree ("created_at");